...
class DKN(object):
    ...
    def _build_model(self, args):
        with tf.name_scope('embedding'):
            ...
            entity_embs = entity_embs.reshape((36350,50))
            ...
            if args.transform:
                ...
                if args.use_context:
                    self.context_embeddings = tf.layers.dense(
                        ...
                        name='transformed_context', kernel_regularizer=tf.keras.regularizers.L2(args.l2_weight)
                        # tf.contrib.layers.l2_regularizer(args.l2_weight)
                    )
